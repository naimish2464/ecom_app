...
import com.example.shopease.databinding.QuantityDialogBinding;
...
public class CartAdapter extends  RecyclerView.Adapter<CartAdapter.CartViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        Glide.with(context)
         ...
         holder.binding.prname.setText(product.getName());
         holder.binding.price.setText("Rs.  "+product.getPrice());
         holder.binding.qty.setText(product.getQuantity() + "item(s)");
